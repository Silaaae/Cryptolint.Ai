...
public class SwitchCompat extends CompoundButton {
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        int typefaceIndex = appearance.getInt(C0139R.styleable.TextAppearance_android_typeface, -1);
        int styleIndex = appearance.getInt(C0139R.styleable.TextAppearance_android_textStyle, -1);
        setSwitchTypefaceByIndex(typefaceIndex, styleIndex);
        boolean allCaps = appearance.getBoolean(C0139R.styleable.TextAppearance_textAllCaps, false);
        if (allCaps) {
