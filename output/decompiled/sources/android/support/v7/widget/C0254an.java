...
class C0254an extends Resources {

    /* JADX INFO: renamed from: a */
    private final Resources f1732a;

    public C0254an(Resources resources) {
    ...
    public int getInteger(int i) {
        return this.f1732a.getInteger(i);
    }
    ...
    public void updateConfiguration(Configuration configuration, DisplayMetrics displayMetrics) {
        ...
        if (this.f1732a != null) {
            this.f1732a.updateConfiguration(configuration, displayMetrics);
        }
    }
}
