...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    public ListMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0139R.styleable.MenuView, defStyle, 0);
    ...
    private void insertIconView() {
        ...
        this.mIconView = (ImageView) inflater.inflate(C0139R.layout.abc_list_menu_item_icon, (ViewGroup) this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        this.mRadioButton = (RadioButton) inflater.inflate(C0139R.layout.abc_list_menu_item_radio, (ViewGroup) this, false);
        addView(this.mRadioButton);
    }

    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        this.mCheckBox = (CheckBox) inflater.inflate(C0139R.layout.abc_list_menu_item_checkbox, (ViewGroup) this, false);
