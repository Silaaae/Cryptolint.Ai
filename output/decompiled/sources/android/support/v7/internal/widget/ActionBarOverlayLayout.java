...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0139R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            ...
            this.mActionBarBottom = (ActionBarContainer) findViewById(C0139R.id.split_action_bar);
        }
    }
