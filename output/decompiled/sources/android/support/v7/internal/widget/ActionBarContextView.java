...
public class ActionBarContextView extends AbsActionBarView implements ViewPropertyAnimatorListener {
    ...
    public ActionBarContextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mSplitBackground = a.getDrawable(C0139R.styleable.ActionMode_backgroundSplit);
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            inflater.inflate(C0139R.layout.abc_action_bar_title_item, this);
    ...
    public void initForMode(final ActionMode mode) {
        ...
        View closeButton = this.mClose.findViewById(C0139R.id.action_mode_close_button);
