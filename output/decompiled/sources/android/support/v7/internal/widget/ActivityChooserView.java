...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(C0139R.layout.abc_activity_chooser_view, (ViewGroup) this, true);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case 0:
                    ...
                    ImageView iconView = (ImageView) convertView.findViewById(C0139R.id.icon);
                    ResolveInfo activity = (ResolveInfo) getItem(position);
                    iconView.setImageDrawable(activity.loadIcon(packageManager));
                    TextView titleView = (TextView) convertView.findViewById(C0139R.id.title);
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0139R.layout.abc_activity_chooser_view_list_item, parent, false);
                        convertView.setId(1);
                        TextView titleView2 = (TextView) convertView.findViewById(C0139R.id.title);
                        titleView2.setText(ActivityChooserView.this.getContext().getString(C0139R.string.abc_activity_chooser_view_see_all));
                    }
                    return convertView;
                default:
                    throw new IllegalArgumentException();
