...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflaterFactory {
    ...
    private void ensureSubDecor() {
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!this.mWindowNoTitle) {
                if (this.mIsFloating) {
                    this.mSubDecor = (ViewGroup) inflater.inflate(C0139R.layout.abc_dialog_title_material, (ViewGroup) null);
                    ...
                    this.mSubDecor = (ViewGroup) LayoutInflater.from(themedContext).inflate(C0139R.layout.abc_screen_toolbar, (ViewGroup) null);
                    this.mDecorContentParent = (DecorContentParent) this.mSubDecor.findViewById(C0139R.id.decor_content_parent);
                ...
                if (this.mOverlayActionMode) {
                    this.mSubDecor = (ViewGroup) inflater.inflate(C0139R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
                } else {
                    this.mSubDecor = (ViewGroup) inflater.inflate(C0139R.layout.abc_screen_simple, (ViewGroup) null);
                }
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) this.mSubDecor.findViewById(C0139R.id.title);
            }
            ...
            ContentFrameLayout abcContent = (ContentFrameLayout) this.mSubDecor.findViewById(C0139R.id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow(ContentFrameLayout contentFrameLayout) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(C0139R.styleable.Theme);
        a.getValue(C0139R.styleable.Theme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        a.getValue(C0139R.styleable.Theme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (a.hasValue(C0139R.styleable.Theme_windowFixedWidthMajor)) {
            a.getValue(C0139R.styleable.Theme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (a.hasValue(C0139R.styleable.Theme_windowFixedWidthMinor)) {
            a.getValue(C0139R.styleable.Theme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (a.hasValue(C0139R.styleable.Theme_windowFixedHeightMajor)) {
            a.getValue(C0139R.styleable.Theme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (a.hasValue(C0139R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(C0139R.styleable.Theme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        a.recycle();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(actionBarContext, (AttributeSet) null, C0139R.attr.actionModePopupWindowStyle);
    ...
    private static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            TypedArray a = context2.obtainStyledAttributes(C0139R.styleable.Theme);
            this.background = a.getResourceId(C0139R.styleable.Theme_panelBackground, 0);
            this.windowAnimations = a.getResourceId(C0139R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
