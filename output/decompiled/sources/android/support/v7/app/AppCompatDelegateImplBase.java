...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!a.hasValue(C0139R.styleable.Theme_windowActionBar)) {
            a.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (a.getBoolean(C0139R.styleable.Theme_windowActionBar, false)) {
            this.mHasActionBar = true;
        }
        if (a.getBoolean(C0139R.styleable.Theme_windowActionBarOverlay, false)) {
            this.mOverlayActionBar = true;
        }
        if (a.getBoolean(C0139R.styleable.Theme_windowActionModeOverlay, false)) {
            this.mOverlayActionMode = true;
        }
        this.mIsFloating = a.getBoolean(C0139R.styleable.Theme_android_windowIsFloating, false);
        this.mWindowNoTitle = a.getBoolean(C0139R.styleable.Theme_windowNoTitle, false);
        a.recycle();
    }
