...
abstract class SystemMediaRouteProvider extends MediaRouteProvider {
    ...
    static class LegacyImpl extends SystemMediaRouteProvider {
        ...
        public void publishRoutes() {
            ...
            MediaRouteDescriptor defaultRoute = new MediaRouteDescriptor.Builder(SystemMediaRouteProvider.DEFAULT_ROUTE_ID, r.getString(C0188R.string.mr_system_route_name)).addControlFilters(CONTROL_FILTERS).setPlaybackStream(3).setPlaybackType(0).setVolumeHandling(1).setVolumeMax(maxVolume).setVolume(this.mLastReportedVolume).build();
    ...
    static class JellybeanImpl extends SystemMediaRouteProvider implements MediaRouterJellybean.Callback, MediaRouterJellybean.VolumeCallback {
        ...
        public JellybeanImpl(Context context, SyncCallback syncCallback) {
            ...
            this.mUserRouteCategoryObj = MediaRouterJellybean.createRouteCategory(this.mRouterObj, r.getString(C0188R.string.mr_user_route_category_name), false);
            updateSystemRoutes();
        }
