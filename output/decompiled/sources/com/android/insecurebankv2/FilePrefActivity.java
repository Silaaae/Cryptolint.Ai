...
public class FilePrefActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0230R.layout.activity_file_pref);
        this.submitPref_buttonz = (Button) findViewById(C0230R.id.submitPref_button);
        edit_serverip = (EditText) findViewById(C0230R.id.edittext_serverip);
        edit_serverport = (EditText) findViewById(C0230R.id.edittext_serverport);
