...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C0230R.layout.activity_log_main);
        String mess = getResources().getString(C0230R.string.is_admin);
        if (mess.equals("no")) {
            View button_CreateUser = findViewById(C0230R.id.button_CreateUser);
