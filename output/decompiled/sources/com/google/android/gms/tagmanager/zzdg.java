...
public class zzdg extends zzdd {
    ...
    private static final String f51ID = com.google.android.gms.internal.zzad.UNIVERSAL_ANALYTICS.toString();
    ...
    */
    private void zzb(Tracker tracker, Map<String, zzag.zza> map) {
        ...
        if (zzi(map, zzaOF)) {
            Object obj = this.zzaKz.get("ecommerce");
            map2 = obj instanceof Map ? (Map) obj : null;
        } else {
            Object objZzl = zzdf.zzl(map.get(zzaOG));
        ...
        if (map2 != null) {
            ...
            if (obj2 instanceof List) {
                for (Map<String, Object> map3 : (List) obj2) {
                    try {
                        screenViewBuilder.addImpression(zzP(map3), (String) map3.get("list"));
            ...
            if (list != null) {
                ...
                while (it.hasNext()) {
                    try {
                        screenViewBuilder.addPromotion(zzO((Map) it.next()));
                ...
                if (map2.containsKey("promoClick")) {
                    ...
                    z = false;
                    if (z) {
                        Iterator<String> it2 = zzaOL.iterator();
                        while (true) {
                            if (!it2.hasNext()) {
                                break;
                            }
                            ...
                            if (map2.containsKey(next)) {
                                ...
                                if (list2 != null) {
                                    ...
                                    while (it3.hasNext()) {
                                        try {
                                            screenViewBuilder.addProduct(zzP((Map) it3.next()));
                                ...
                                try {
                                    screenViewBuilder.setProductAction(map4.containsKey("actionField") ? zze(next, (Map) map4.get("actionField")) : new ProductAction(next));
                                } catch (RuntimeException e4) {
                                    zzbg.zzaz("Failed to extract a product action from DataLayer. " + e4.getMessage());
                                }
                            }
                        }
                    }
