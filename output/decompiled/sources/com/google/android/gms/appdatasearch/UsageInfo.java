...
public class UsageInfo implements SafeParcelable {
    ...
    private static DocumentSection zzh(List<AppIndexApi.AppIndexingLink> list) {
        ...
        zznj.zza.C1273zza[] c1273zzaArr = new zznj.zza.C1273zza[list.size()];
        int i = 0;
        while (true) {
            int i2 = i;
            if (i2 >= c1273zzaArr.length) {
                zzaVar.zzawk = c1273zzaArr;
            ...
            c1273zzaArr[i2] = new zznj.zza.C1273zza();
            AppIndexApi.AppIndexingLink appIndexingLink = list.get(i2);
            c1273zzaArr[i2].zzawm = appIndexingLink.appIndexingUrl.toString();
            c1273zzaArr[i2].viewId = appIndexingLink.viewId;
            if (appIndexingLink.webUrl != null) {
                c1273zzaArr[i2].zzawn = appIndexingLink.webUrl.toString();
            }
            i = i2 + 1;
        }
    }
