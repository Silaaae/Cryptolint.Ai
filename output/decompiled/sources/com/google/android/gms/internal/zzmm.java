...
public interface zzmm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmm {
        ...
        private static class C1262zza implements zzmm {
        ...
        public static zzmm zzbx(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmm)) ? new C1262zza(iBinder) : (zzmm) iInterfaceQueryLocalInterface;
        }
