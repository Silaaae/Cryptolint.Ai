...
public interface zzos extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzos {
        ...
        private static class C1282zza implements zzos {
            private IBinder zznF;

            C1282zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzos zzdc(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzos)) ? new C1282zza(iBinder) : (zzos) iInterfaceQueryLocalInterface;
        }
