...
public interface zzpi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpi {
        ...
        private static class C1286zza implements zzpi {
            private IBinder zznF;

            C1286zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzpi zzdx(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzpi)) ? new C1286zza(iBinder) : (zzpi) iInterfaceQueryLocalInterface;
        }
