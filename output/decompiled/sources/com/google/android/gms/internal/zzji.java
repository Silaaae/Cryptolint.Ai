...
public interface zzji extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzji {
        ...
        private static class C1243zza implements zzji {
        ...
        public static zzji zzao(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzji)) ? new C1243zza(iBinder) : (zzji) iInterfaceQueryLocalInterface;
        }
