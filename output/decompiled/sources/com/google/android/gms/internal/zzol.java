...
public interface zzol extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzol {
        ...
        private static class C1278zza implements zzol {
        ...
        public static zzol zzcX(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzol)) ? new C1278zza(iBinder) : (zzol) iInterfaceQueryLocalInterface;
        }
