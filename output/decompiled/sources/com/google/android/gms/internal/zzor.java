...
public interface zzor extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzor {
        ...
        private static class C1281zza implements zzor {
            private IBinder zznF;

            C1281zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzor zzdb(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzor)) ? new C1281zza(iBinder) : (zzor) iInterfaceQueryLocalInterface;
        }
