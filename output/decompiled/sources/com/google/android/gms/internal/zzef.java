...
public interface zzef extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzef {
        ...
        private static class C1225zza implements zzef {
            private IBinder zznF;

            C1225zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzef zzE(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzef)) ? new C1225zza(iBinder) : (zzef) iInterfaceQueryLocalInterface;
        }
