...
public interface zzcs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcs {
        ...
        private static class C1218zza implements zzcs {
            private IBinder zznF;

            C1218zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcs zzy(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcs)) ? new C1218zza(iBinder) : (zzcs) iInterfaceQueryLocalInterface;
        }
