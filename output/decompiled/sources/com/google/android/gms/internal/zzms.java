...
public interface zzms extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzms {
        ...
        private static class C1268zza implements zzms {
            private IBinder zznF;

            C1268zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzms zzbD(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzms)) ? new C1268zza(iBinder) : (zzms) iInterfaceQueryLocalInterface;
        }
