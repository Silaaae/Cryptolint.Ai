...
public interface zzfj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfj {
        ...
        private static class C1235zza implements zzfj {
            private IBinder zznF;

            C1235zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzfj zzQ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfj)) ? new C1235zza(iBinder) : (zzfj) iInterfaceQueryLocalInterface;
        }
