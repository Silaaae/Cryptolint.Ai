...
public interface zzmh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmh {
        ...
        private static class C1257zza implements zzmh {
            private IBinder zznF;

            C1257zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzmh zzbs(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmh)) ? new C1257zza(iBinder) : (zzmh) iInterfaceQueryLocalInterface;
        }
