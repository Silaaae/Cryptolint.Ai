...
public interface zzpn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpn {
        ...
        private static class C1288zza implements zzpn {
        ...
        public static zzpn zzdA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzpn)) ? new C1288zza(iBinder) : (zzpn) iInterfaceQueryLocalInterface;
        }
