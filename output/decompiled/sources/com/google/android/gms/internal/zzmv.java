...
public interface zzmv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmv {
        ...
        private static class C1271zza implements zzmv {
            private IBinder zznF;

            C1271zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzmv zzbG(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmv)) ? new C1271zza(iBinder) : (zzmv) iInterfaceQueryLocalInterface;
        }
