...
public interface zziq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zziq {
        ...
        private static class C1236zza implements zziq {
            private IBinder zznF;

            C1236zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zziq zzad(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zziq)) ? new C1236zza(iBinder) : (zziq) iInterfaceQueryLocalInterface;
        }
