...
public interface zzmt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmt {
        ...
        private static class C1269zza implements zzmt {
            private IBinder zznF;

            C1269zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzmt zzbE(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmt)) ? new C1269zza(iBinder) : (zzmt) iInterfaceQueryLocalInterface;
        }
