...
public class zzer extends zzeu {
    ...
    public void execute() {
        ...
        builderZzJ.setTitle(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.store_picture_title, "Save image"));
        builderZzJ.setMessage(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.store_picture_message, "Allow Ad to store image in Picture gallery?"));
        builderZzJ.setPositiveButton(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.accept, "Accept"), new DialogInterface.OnClickListener() { // from class: com.google.android.gms.internal.zzer.1
        ...
        builderZzJ.setNegativeButton(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.decline, "Decline"), new DialogInterface.OnClickListener() { // from class: com.google.android.gms.internal.zzer.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
