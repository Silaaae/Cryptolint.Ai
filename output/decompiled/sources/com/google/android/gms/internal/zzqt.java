...
public interface zzqt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqt {
        ...
        private static class C1293zza implements zzqt {
        ...
        public static zzqt zzdI(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqt)) ? new C1293zza(iBinder) : (zzqt) iInterfaceQueryLocalInterface;
        }
