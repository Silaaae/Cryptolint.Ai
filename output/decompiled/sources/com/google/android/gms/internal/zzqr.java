...
public interface zzqr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqr {
        ...
        private static class C1291zza implements zzqr {
        ...
        public static zzqr zzdG(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqr)) ? new C1291zza(iBinder) : (zzqr) iInterfaceQueryLocalInterface;
        }
