...
public interface zzcv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcv {
        ...
        private static class C1220zza implements zzcv {
            private IBinder zznF;

            C1220zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcv zzA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcv)) ? new C1220zza(iBinder) : (zzcv) iInterfaceQueryLocalInterface;
        }
