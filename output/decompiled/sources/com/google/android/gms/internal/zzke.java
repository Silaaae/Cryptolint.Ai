...
public interface zzke extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzke {
        ...
        private static class C1250zza implements zzke {
        ...
        public static zzke zzaB(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzke)) ? new C1250zza(iBinder) : (zzke) iInterfaceQueryLocalInterface;
        }
