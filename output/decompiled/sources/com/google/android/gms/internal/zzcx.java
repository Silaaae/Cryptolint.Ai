...
public interface zzcx extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcx {
        ...
        private static class C1222zza implements zzcx {
            private IBinder zznF;

            C1222zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcx zzC(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcx)) ? new C1222zza(iBinder) : (zzcx) iInterfaceQueryLocalInterface;
        }
