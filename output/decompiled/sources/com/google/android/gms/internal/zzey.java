...
public interface zzey extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzey {
        ...
        private static class C1229zza implements zzey {
            private IBinder zznF;

            C1229zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzey zzJ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzey)) ? new C1229zza(iBinder) : (zzey) iInterfaceQueryLocalInterface;
        }
