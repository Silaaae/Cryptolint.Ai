...
public interface zzkr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkr {
        ...
        private static class C1253zza implements zzkr {
        ...
        public static zzkr zzaM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzkr)) ? new C1253zza(iBinder) : (zzkr) iInterfaceQueryLocalInterface;
        }
