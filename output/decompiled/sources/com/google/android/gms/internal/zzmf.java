...
public interface zzmf extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmf {
        ...
        private static class C1255zza implements zzmf {
        ...
        public static zzmf zzbq(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmf)) ? new C1255zza(iBinder) : (zzmf) iInterfaceQueryLocalInterface;
        }
