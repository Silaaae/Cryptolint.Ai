...
public interface zzjh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjh {
        ...
        private static class C1242zza implements zzjh {
        ...
        public static zzjh zzan(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzjh)) ? new C1242zza(iBinder) : (zzjh) iInterfaceQueryLocalInterface;
        }
