...
public interface zzjk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjk {
        ...
        private static class C1244zza implements zzjk {
        ...
        public static zzjk zzas(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzjk)) ? new C1244zza(iBinder) : (zzjk) iInterfaceQueryLocalInterface;
        }
