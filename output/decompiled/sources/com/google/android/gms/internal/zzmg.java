...
public interface zzmg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmg {
        ...
        private static class C1256zza implements zzmg {
        ...
        public static zzmg zzbr(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmg)) ? new C1256zza(iBinder) : (zzmg) iInterfaceQueryLocalInterface;
        }
