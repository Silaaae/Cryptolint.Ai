...
public interface zzqu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqu {
        ...
        private static class C1294zza implements zzqu {
        ...
        public static zzqu zzdJ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqu)) ? new C1294zza(iBinder) : (zzqu) iInterfaceQueryLocalInterface;
        }
