...
public interface zzck extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzck {
        ...
        private static class C1213zza implements zzck {
            private IBinder zznF;

            C1213zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzck zzt(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzck)) ? new C1213zza(iBinder) : (zzck) iInterfaceQueryLocalInterface;
        }
