...
public interface zzpm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzpm {
        ...
        private static class C1287zza implements zzpm {
        ...
        public static zzpm zzdz(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzpm)) ? new C1287zza(iBinder) : (zzpm) iInterfaceQueryLocalInterface;
        }
