...
public interface zzph extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzph {
        ...
        private static class C1285zza implements zzph {
            private IBinder zznF;

            C1285zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzph zzdw(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzph)) ? new C1285zza(iBinder) : (zzph) iInterfaceQueryLocalInterface;
        }
