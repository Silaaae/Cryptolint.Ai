...
public interface zzme extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzme {
        ...
        private static class C1254zza implements zzme {
        ...
        public static zzme zzbp(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzme)) ? new C1254zza(iBinder) : (zzme) iInterfaceQueryLocalInterface;
        }
