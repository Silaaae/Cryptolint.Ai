...
public interface zzmp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmp {
        ...
        private static class C1265zza implements zzmp {
        ...
        public static zzmp zzbA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmp)) ? new C1265zza(iBinder) : (zzmp) iInterfaceQueryLocalInterface;
        }
