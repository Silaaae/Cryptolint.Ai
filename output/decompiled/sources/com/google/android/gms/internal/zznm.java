...
public interface zznm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zznm {
        ...
        private static class C1275zza implements zznm {
        ...
        public static zznm zzbQ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zznm)) ? new C1275zza(iBinder) : (zznm) iInterfaceQueryLocalInterface;
        }
