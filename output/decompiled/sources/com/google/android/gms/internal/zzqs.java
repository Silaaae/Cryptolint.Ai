...
public interface zzqs extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzqs {
        ...
        private static class C1292zza implements zzqs {
        ...
        public static zzqs zzdH(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzqs)) ? new C1292zza(iBinder) : (zzqs) iInterfaceQueryLocalInterface;
        }
