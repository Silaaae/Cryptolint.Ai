...
public interface zzni extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzni {
        ...
        private static class C1272zza implements zzni {
            private IBinder zznF;

            C1272zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzni zzbH(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzni)) ? new C1272zza(iBinder) : (zzni) iInterfaceQueryLocalInterface;
        }
