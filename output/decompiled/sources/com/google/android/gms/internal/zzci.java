...
public interface zzci extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzci {
        ...
        private static class C1212zza implements zzci {
            private IBinder zznF;

            C1212zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzci zzs(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzci)) ? new C1212zza(iBinder) : (zzci) iInterfaceQueryLocalInterface;
        }
