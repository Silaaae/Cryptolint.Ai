...
public interface zzcw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcw {
        ...
        private static class C1221zza implements zzcw {
            private IBinder zznF;

            C1221zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcw zzB(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcw)) ? new C1221zza(iBinder) : (zzcw) iInterfaceQueryLocalInterface;
        }
