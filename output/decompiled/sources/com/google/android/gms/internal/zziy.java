...
public interface zziy extends IInterface {
    ...
    public static abstract class zza extends Binder implements zziy {
        ...
        private static class C1238zza implements zziy {
            private IBinder zznF;

            C1238zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zziy zzah(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zziy)) ? new C1238zza(iBinder) : (zziy) iInterfaceQueryLocalInterface;
        }
