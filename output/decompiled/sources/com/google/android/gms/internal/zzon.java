...
public interface zzon extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzon {
        ...
        private static class C1280zza implements zzon {
        ...
        public static zzon zzcZ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzon)) ? new C1280zza(iBinder) : (zzon) iInterfaceQueryLocalInterface;
        }
