        ...
        public static final class C1296zza extends zzrh<C1296zza> {
            ...
            public static final class C1297zza extends zzrh<C1297zza> {
                ...
                public boolean equals(Object o) {
                    ...
                    if (!(o instanceof C1297zza)) {
                        return false;
                    }
                    C1297zza c1297zza = (C1297zza) o;
                    if (!Arrays.equals(this.zzaVq, c1297zza.zzaVq)) {
                        return false;
                    }
                    if (this.zzaVr == null) {
                        if (c1297zza.zzaVr != null) {
                            return false;
                        }
                    } else if (!this.zzaVr.equals(c1297zza.zzaVr)) {
                        return false;
                    }
                    if (Double.doubleToLongBits(this.zzaVs) == Double.doubleToLongBits(c1297zza.zzaVs) && Float.floatToIntBits(this.zzaVt) == Float.floatToIntBits(c1297zza.zzaVt) && this.zzaVu == c1297zza.zzaVu && this.zzaVv == c1297zza.zzaVv && this.zzaVw == c1297zza.zzaVw && this.zzaVx == c1297zza.zzaVx && zzrl.equals(this.zzaVy, c1297zza.zzaVy) && zzrl.equals(this.zzaVz, c1297zza.zzaVz) && zzrl.equals(this.zzaVA, c1297zza.zzaVA) && zzrl.equals(this.zzaVB, c1297zza.zzaVB) && zzrl.equals(this.zzaVC, c1297zza.zzaVC) && this.zzaVD == c1297zza.zzaVD) {
                        return zza(c1297zza);
                    }
                    return false;
                }
                ...
                protected int zzB() {
                    ...
                    if (this.zzaVz != null && this.zzaVz.length > 0) {
                        ...
                        for (int i2 = 0; i2 < this.zzaVz.length; i2++) {
                            C1296zza c1296zza = this.zzaVz[i2];
                            if (c1296zza != null) {
                                iZzc2 += zzrg.zzc(10, c1296zza);
                            }
                        }
                        iZzB = iZzc2;
                    }
                ...
                public C1297zza zzb(zzrf zzrfVar) throws IOException {
                    while (true) {
                        ...
                        switch (iZzBr) {
                            ...
                            case 82:
                                ...
                                C1296zza[] c1296zzaArr = new C1296zza[iZzb2 + length2];
                                if (length2 != 0) {
                                    System.arraycopy(this.zzaVz, 0, c1296zzaArr, 0, length2);
                                }
                                while (length2 < c1296zzaArr.length - 1) {
                                    c1296zzaArr[length2] = new C1296zza();
                                    zzrfVar.zza(c1296zzaArr[length2]);
                                    zzrfVar.zzBr();
                                    length2++;
                                }
                                c1296zzaArr[length2] = new C1296zza();
                                zzrfVar.zza(c1296zzaArr[length2]);
                                this.zzaVz = c1296zzaArr;
                                break;
                            case 90:
            ...
            public static C1296zza[] zzBn() {
                if (zzaVo == null) {
                    synchronized (zzrl.zzaWe) {
                        if (zzaVo == null) {
                            zzaVo = new C1296zza[0];
                        }
                    }
                }
                return zzaVo;
            ...
            public boolean equals(Object o) {
                ...
                if (!(o instanceof C1296zza)) {
                    return false;
                }
                C1296zza c1296zza = (C1296zza) o;
                if (this.type != c1296zza.type) {
                    return false;
                }
                if (this.zzaVp == null) {
                    if (c1296zza.zzaVp != null) {
                        return false;
                    }
                } else if (!this.zzaVp.equals(c1296zza.zzaVp)) {
                    return false;
                }
                return zza(c1296zza);
            }
            ...
            public C1296zza zzb(zzrf zzrfVar) throws IOException {
                while (true) {
                    int iZzBr = zzrfVar.zzBr();
                    switch (iZzBr) {
                        case 0:
