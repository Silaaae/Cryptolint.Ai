...
public interface zzcq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcq {
        ...
        private static class C1217zza implements zzcq {
            private IBinder zznF;

            C1217zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcq zzx(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcq)) ? new C1217zza(iBinder) : (zzcq) iInterfaceQueryLocalInterface;
        }
