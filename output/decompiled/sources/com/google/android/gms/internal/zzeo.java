...
public class zzeo extends zzeu {
    ...
    public void execute() {
        ...
        builderZzJ.setTitle(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.create_calendar_title, "Create calendar event"));
        builderZzJ.setMessage(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.create_calendar_message, "Allow Ad to create a calendar event?"));
        builderZzJ.setPositiveButton(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.accept, "Accept"), new DialogInterface.OnClickListener() { // from class: com.google.android.gms.internal.zzeo.1
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
                zzeo.this.mContext.startActivity(zzeo.this.createIntent());
            }
        });
        builderZzJ.setNegativeButton(com.google.android.gms.ads.internal.zzo.zzby().zzc(C0231R.string.decline, "Decline"), new DialogInterface.OnClickListener() { // from class: com.google.android.gms.internal.zzeo.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialog, int which) {
