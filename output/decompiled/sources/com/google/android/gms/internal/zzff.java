...
public interface zzff extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzff {
        ...
        private static class C1231zza implements zzff {
            private IBinder zznF;

            C1231zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzff zzM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzff)) ? new C1231zza(iBinder) : (zzff) iInterfaceQueryLocalInterface;
        }
