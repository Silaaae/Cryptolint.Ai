...
public class zzdt {
    ...
    /* JADX INFO: renamed from: com.google.android.gms.internal.zzdt$1 */
    class RunnableC07981 implements Runnable {
        final /* synthetic */ zze zzwT;

        /* JADX INFO: renamed from: com.google.android.gms.internal.zzdt$1$1, reason: invalid class name */
        class AnonymousClass1 implements zzbb.zza {
            final /* synthetic */ zzbb zzwV;

            AnonymousClass1(zzbb zzbbVar) {
                this.zzwV = zzbbVar;
            }
                ...
                new Timer().schedule(new TimerTask() { // from class: com.google.android.gms.internal.zzdt.1.1.1
                    ...
                    public void run() {
                        synchronized (zzdt.this.zzqt) {
                            if (RunnableC07981.this.zzwT.getStatus() == -1 || RunnableC07981.this.zzwT.getStatus() == 1) {
                                return;
                            }
                            RunnableC07981.this.zzwT.reject();
                            zzhl.runOnUiThread(new Runnable() { // from class: com.google.android.gms.internal.zzdt.1.1.1.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    AnonymousClass1.this.zzwV.destroy();
                                }
                            });
        ...
        public void run() {
            ...
            zzbbVarZza.zza(new AnonymousClass1(zzbbVarZza));
            zzbbVarZza.zza("/jsLoaded", new zzdg() { // from class: com.google.android.gms.internal.zzdt.1.2
                ...
                public void zza(zzid zzidVar, Map<String, String> map) {
                    synchronized (zzdt.this.zzqt) {
                        ...
                        RunnableC07981.this.zzwT.zzg(zzbbVarZza);
                        zzdt.this.zzwR = RunnableC07981.this.zzwT;
    ...
    private zze zzdS() {
        ...
        zzhl.runOnUiThread(new RunnableC07981(zzeVar));
        return zzeVar;
    }
