...
public interface zzcu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcu {
        ...
        private static class C1219zza implements zzcu {
            private IBinder zznF;

            C1219zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcu zzz(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcu)) ? new C1219zza(iBinder) : (zzcu) iInterfaceQueryLocalInterface;
        }
