...
public interface zzkq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkq {
        ...
        private static class C1252zza implements zzkq {
        ...
        public static zzkq zzaL(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzkq)) ? new C1252zza(iBinder) : (zzkq) iInterfaceQueryLocalInterface;
        }
