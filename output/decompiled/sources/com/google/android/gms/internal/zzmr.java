...
public interface zzmr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmr {
        ...
        private static class C1267zza implements zzmr {
        ...
        public static zzmr zzbC(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmr)) ? new C1267zza(iBinder) : (zzmr) iInterfaceQueryLocalInterface;
        }
