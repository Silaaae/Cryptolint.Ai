...
public interface zzou extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzou {
        ...
        private static class C1284zza implements zzou {
        ...
        public static zzou zzdn(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzou)) ? new C1284zza(iBinder) : (zzou) iInterfaceQueryLocalInterface;
        }
