...
public interface zzjl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzjl {
        ...
        private static class C1245zza implements zzjl {
        ...
        public static zzjl zzat(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzjl)) ? new C1245zza(iBinder) : (zzjl) iInterfaceQueryLocalInterface;
        }
