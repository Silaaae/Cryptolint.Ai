...
public interface zzcn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcn {
        ...
        private static class C1215zza implements zzcn {
            private IBinder zznF;

            C1215zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcn zzv(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcn)) ? new C1215zza(iBinder) : (zzcn) iInterfaceQueryLocalInterface;
        }
