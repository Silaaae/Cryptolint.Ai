...
public interface zzok extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzok {
        ...
        private static class C1277zza implements zzok {
        ...
        public static zzok zzcW(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzok)) ? new C1277zza(iBinder) : (zzok) iInterfaceQueryLocalInterface;
        }
