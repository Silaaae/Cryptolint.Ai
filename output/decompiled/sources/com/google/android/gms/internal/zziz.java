...
public interface zziz extends IInterface {
    ...
    public static abstract class zza extends Binder implements zziz {
        ...
        private static class C1239zza implements zziz {
            private IBinder zznF;

            C1239zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zziz zzai(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zziz)) ? new C1239zza(iBinder) : (zziz) iInterfaceQueryLocalInterface;
        }
