...
public interface zzcm extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzcm {
        ...
        private static class C1214zza implements zzcm {
            private IBinder zznF;

            C1214zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzcm zzu(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzcm)) ? new C1214zza(iBinder) : (zzcm) iInterfaceQueryLocalInterface;
        }
