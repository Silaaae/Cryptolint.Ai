...
public interface zzex extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzex {
        ...
        private static class C1228zza implements zzex {
            private IBinder zznF;

            C1228zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzex zzI(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzex)) ? new C1228zza(iBinder) : (zzex) iInterfaceQueryLocalInterface;
        }
