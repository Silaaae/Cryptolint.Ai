...
public interface zzfh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfh {
        ...
        private static class C1233zza implements zzfh {
            private IBinder zznF;

            C1233zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzfh zzO(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfh)) ? new C1233zza(iBinder) : (zzfh) iInterfaceQueryLocalInterface;
        }
