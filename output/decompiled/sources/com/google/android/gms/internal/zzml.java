...
public interface zzml extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzml {
        ...
        private static class C1261zza implements zzml {
            private IBinder zznF;

            C1261zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzml zzbw(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzml)) ? new C1261zza(iBinder) : (zzml) iInterfaceQueryLocalInterface;
        }
