...
public interface zzco extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzco {
        ...
        private static class C1216zza implements zzco {
            private IBinder zznF;

            C1216zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzco zzw(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzco)) ? new C1216zza(iBinder) : (zzco) iInterfaceQueryLocalInterface;
        }
