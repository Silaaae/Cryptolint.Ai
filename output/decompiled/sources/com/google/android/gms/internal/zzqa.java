...
public class zzqa {
    ...
    class zzb extends zzqn {
        ...
        protected void zza(zzqe zzqeVar) {
            ...
            if (zzaVarZzAg.getStatus() == Status.zzXP && zzaVarZzAg.zzAh() == zzqe.zza.EnumC1289zza.NETWORK && zzaVarZzAg.zzAi() != null && zzaVarZzAg.zzAi().length > 0) {
    ...
    void zza(final zzpy zzpyVar, final zza zzaVar) {
        this.zzaPe.zza(zzpyVar.zzAb(), zzpyVar.zzzZ(), zzqc.zzaPm, new zzqg() { // from class: com.google.android.gms.internal.zzqa.1
            ...
            public void zza(Status status, Object obj, Integer num, long j) {
                zzqe.zza zzaVar2;
                if (status.isSuccess()) {
                    zzaVar2 = new zzqe.zza(Status.zzXP, zzpyVar, null, (zzqf.zzc) obj, num == zzqh.zzaPM ? zzqe.zza.EnumC1289zza.DEFAULT : zzqe.zza.EnumC1289zza.DISK, j);
                } else {
                    zzaVar2 = new zzqe.zza(new Status(16, "There is no valid resource for the container: " + zzpyVar.getContainerId()), null, zzqe.zza.EnumC1289zza.DISK);
                }
