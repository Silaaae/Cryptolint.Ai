...
public interface zzkd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzkd {
        ...
        private static class C1249zza implements zzkd {
        ...
        public static zzkd zzaA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzkd)) ? new C1249zza(iBinder) : (zzkd) iInterfaceQueryLocalInterface;
        }
