...
public abstract class zzqn {
    ...
    public class zzb {
        private final zzqe.zza.EnumC1289zza zzaPp;
        ...
        public zzqe.zza.EnumC1289zza zzAh() {
            return this.zzaPp;
        }
    ...
    public void zza(zza zzaVar) {
        ...
        zza(new zzqe((zzbVarZza == null || !(zzbVarZza.zzAH() instanceof zzqf.zzc)) ? new zzqe.zza(Status.zzXR, zzpyVar, zzqe.zza.EnumC1289zza.NETWORK) : new zzqe.zza(Status.zzXP, zzpyVar, null, (zzqf.zzc) zzbVarZza.zzAH(), zzbVarZza.zzAh(), zzbVarZza.zzAl())));
    }

    public void zzu(byte[] bArr) {
        long j;
        zzqe.zza.EnumC1289zza enumC1289zzaZzAh;
        Object obj;
        com.google.android.gms.tagmanager.zzbg.zzaB("ResourceManager: Resource downloaded from Network: " + this.zzaPU.getId());
        zzpy zzpyVar = this.zzaPU.zzAf().get(0);
        zzqe.zza.EnumC1289zza enumC1289zzaZzAh2 = zzqe.zza.EnumC1289zza.NETWORK;
        Object objZzt = null;
        try {
            ...
            if (objZzt == null) {
                ...
                if (zzbVarZza != null) {
                    ...
                    enumC1289zzaZzAh2 = zzbVarZza.zzAh();
                    jCurrentTimeMillis = zzbVarZza.zzAl();
                }
            }
            j = jCurrentTimeMillis;
            enumC1289zzaZzAh = enumC1289zzaZzAh2;
            obj = objZzt;
        } catch (zzqf.zzg e) {
            ...
            if (zzbVarZza2 != null) {
                ...
                j = 0;
                enumC1289zzaZzAh = zzbVarZza2.zzAh();
                obj = objZzAH;
            } else {
                j = 0;
                enumC1289zzaZzAh = enumC1289zzaZzAh2;
        ...
        zza(new zzqe(obj != null ? new zzqe.zza(Status.zzXP, zzpyVar, bArr, (zzqf.zzc) obj, enumC1289zzaZzAh, j) : new zzqe.zza(Status.zzXR, zzpyVar, zzqe.zza.EnumC1289zza.NETWORK)));
    }
}
