...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C1298zza> zzal = new ArrayList();
        ...
        private static class C1298zza {
            public final String name;
            public final long time;
            public final long zzan;

            public C1298zza(String str, long j, long j2) {
                this.name = str;
                this.zzan = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzal.add(new C1298zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (jZzx > 0) {
                ...
                long j2 = j;
                for (C1298zza c1298zza : this.zzal) {
                    long j3 = c1298zza.time;
                    zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(c1298zza.zzan), c1298zza.name);
                    j2 = j3;
                }
            }
        }
