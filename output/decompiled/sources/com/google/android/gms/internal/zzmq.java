...
public interface zzmq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmq {
        ...
        private static class C1266zza implements zzmq {
            private IBinder zznF;

            C1266zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzmq zzbB(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmq)) ? new C1266zza(iBinder) : (zzmq) iInterfaceQueryLocalInterface;
        }
