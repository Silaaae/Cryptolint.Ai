...
public interface zzom extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzom {
        ...
        private static class C1279zza implements zzom {
        ...
        public static zzom zzcY(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzom)) ? new C1279zza(iBinder) : (zzom) iInterfaceQueryLocalInterface;
        }
