...
public interface zzeg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzeg {
        ...
        private static class C1226zza implements zzeg {
            private IBinder zznF;

            C1226zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzeg zzF(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzeg)) ? new C1226zza(iBinder) : (zzeg) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 10:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
                    zza(zzd.zza.zzbg(parcel.readStrongBinder()), parcel.readInt() != 0 ? AdRequestParcel.CREATOR.createFromParcel(parcel) : null, parcel.readString(), zza.AbstractBinderC1165zza.zzab(parcel.readStrongBinder()), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 11:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
