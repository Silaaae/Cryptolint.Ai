...
public interface zzfg extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzfg {
        ...
        private static class C1232zza implements zzfg {
            private IBinder zznF;

            C1232zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzfg zzN(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzfg)) ? new C1232zza(iBinder) : (zzfg) iInterfaceQueryLocalInterface;
        }
