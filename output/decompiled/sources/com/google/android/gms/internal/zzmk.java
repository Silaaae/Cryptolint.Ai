...
public interface zzmk extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmk {
        ...
        private static class C1260zza implements zzmk {
        ...
        public static zzmk zzbv(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmk)) ? new C1260zza(iBinder) : (zzmk) iInterfaceQueryLocalInterface;
        }
