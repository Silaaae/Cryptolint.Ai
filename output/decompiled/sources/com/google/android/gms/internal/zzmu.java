...
public interface zzmu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzmu {
        ...
        private static class C1270zza implements zzmu {
            private IBinder zznF;

            C1270zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzmu zzbF(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzmu)) ? new C1270zza(iBinder) : (zzmu) iInterfaceQueryLocalInterface;
        }
