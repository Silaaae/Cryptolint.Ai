...
public interface zzoj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzoj {
        ...
        private static class C1276zza implements zzoj {
        ...
        public static zzoj zzcV(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzoj)) ? new C1276zza(iBinder) : (zzoj) iInterfaceQueryLocalInterface;
        }
