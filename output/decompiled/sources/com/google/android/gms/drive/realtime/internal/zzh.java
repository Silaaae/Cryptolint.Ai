...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class C1192zza implements zzh {
            private IBinder zznF;

            C1192zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzh zzaX(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzh)) ? new C1192zza(iBinder) : (zzh) iInterfaceQueryLocalInterface;
        }
