...
public interface zzam extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzam {
        ...
        private static class C1185zza implements zzam {
            private IBinder zznF;

            C1185zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzam zzaQ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzam)) ? new C1185zza(iBinder) : (zzam) iInterfaceQueryLocalInterface;
        }
