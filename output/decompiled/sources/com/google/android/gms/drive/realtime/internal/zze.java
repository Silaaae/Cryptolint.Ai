...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        private static class C1189zza implements zze {
            private IBinder zznF;

            C1189zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zze zzaU(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zze)) ? new C1189zza(iBinder) : (zze) iInterfaceQueryLocalInterface;
        }
