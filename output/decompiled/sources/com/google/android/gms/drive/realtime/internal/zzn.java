...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C1198zza implements zzn {
            private IBinder zznF;

            C1198zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzn zzbd(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzn)) ? new C1198zza(iBinder) : (zzn) iInterfaceQueryLocalInterface;
        }
