...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C1199zza implements zzo {
            private IBinder zznF;

            C1199zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzo zzbe(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzo)) ? new C1199zza(iBinder) : (zzo) iInterfaceQueryLocalInterface;
        }
