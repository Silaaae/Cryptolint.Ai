...
public interface zzan extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzan {
        ...
        private static class C1186zza implements zzan {
            private IBinder zznF;

            C1186zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzan zzaR(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzan)) ? new C1186zza(iBinder) : (zzan) iInterfaceQueryLocalInterface;
        }
