...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C1205zza implements zzn {
            private IBinder zznF;

            C1205zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzn zzbI(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzn)) ? new C1205zza(iBinder) : (zzn) iInterfaceQueryLocalInterface;
        }
