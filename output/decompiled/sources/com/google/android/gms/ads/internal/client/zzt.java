...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C1152zza implements zzt {
            private IBinder zznF;

            C1152zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzt zzm(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzt)) ? new C1152zza(iBinder) : (zzt) iInterfaceQueryLocalInterface;
        }
