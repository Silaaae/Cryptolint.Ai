...
public interface zzj extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzj {
        ...
        private static class C1159zza implements zzj {
            private IBinder zznF;

            C1159zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzj zzV(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzj)) ? new C1159zza(iBinder) : (zzj) iInterfaceQueryLocalInterface;
        }
