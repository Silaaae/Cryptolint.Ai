...
public final class zzj {
    ...
    public zzj(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainAttributes = context.getResources().obtainAttributes(attributeSet, C0231R.styleable.AdsAttrs);
        String string = typedArrayObtainAttributes.getString(C0231R.styleable.AdsAttrs_adSize);
        String string2 = typedArrayObtainAttributes.getString(C0231R.styleable.AdsAttrs_adSizes);
        ...
        this.zzoL = typedArrayObtainAttributes.getString(C0231R.styleable.AdsAttrs_adUnitId);
