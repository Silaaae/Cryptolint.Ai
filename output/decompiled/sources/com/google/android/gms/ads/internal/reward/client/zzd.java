...
public interface zzd extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzd {
        ...
        private static class C1164zza implements zzd {
            private IBinder zznF;

            C1164zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzd zzZ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzd)) ? new C1164zza(iBinder) : (zzd) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAdListener");
                    zza(zza.AbstractBinderC1160zza.zzW(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 6:
                    data.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAdListener");
