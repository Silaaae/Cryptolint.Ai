...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C1163zza implements zzc {
            private IBinder zznF;

            C1163zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzc zzY(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzc)) ? new C1163zza(iBinder) : (zzc) iInterfaceQueryLocalInterface;
        }
