...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C1149zza implements zzq {
            private IBinder zznF;

            C1149zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzq zzj(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzq)) ? new C1149zza(iBinder) : (zzq) iInterfaceQueryLocalInterface;
        }
