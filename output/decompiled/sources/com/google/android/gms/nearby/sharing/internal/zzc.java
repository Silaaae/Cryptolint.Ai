...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C1358zza implements zzc {
            private IBinder zznF;

            C1358zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzc zzdj(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzc)) ? new C1358zza(iBinder) : (zzc) iInterfaceQueryLocalInterface;
        }
