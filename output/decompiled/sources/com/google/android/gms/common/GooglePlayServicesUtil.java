...
public final class GooglePlayServicesUtil {
    ...
    /* JADX WARN: Type inference failed for: r3v3, types: [android.content.pm.PackageManager] */
    ...
    /* JADX WARN: Type inference failed for: r5v3, types: [com.google.android.gms.common.zzd] */
    /* JADX WARN: Type inference failed for: r5v5, types: [com.google.android.gms.common.zzd] */
    ...
    */
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0231R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
        ...
        try {
            ...
            if (!zzkz.zzbP(packageInfo.versionCode) && !zzkz.zzai(context)) {
                try {
                    zzc.zza zzaVarZza = Zzmn.zza(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), zzc.zzbk.zzVR);
                    if (zzaVarZza == null) {
                        ...
                        r3 = packageManager;
                        if (Zzmn.zza(packageInfo, zzaVarZza) == null) {
            ...
            int iZzbN = zzkz.zzbN(GOOGLE_PLAY_SERVICES_VERSION_CODE);
            int iZzbN2 = zzkz.zzbN(packageInfo.versionCode);
            if (iZzbN2 < iZzbN) {
                StringBuilder sbAppend = new StringBuilder().append("Google Play services out of date.  Requires ").append(GOOGLE_PLAY_SERVICES_VERSION_CODE).append(" but found ");
                i = packageInfo.versionCode;
                string = sbAppend.append(i).toString();
                Log.w("GooglePlayServicesUtil", string);
                r0 = 2;
                packageManager = r3;
                Zzmn = iZzbN2;
            } else {
                ...
                if (applicationInfo == null) {
                    try {
                        packageInfo = null;
                        applicationInfo = r3.getApplicationInfo("com.google.android.gms", 0);
                        ...
                        e2.printStackTrace();
                        r0 = i;
                        packageManager = "Google Play services missing when getting application info.";
                        Zzmn = iZzbN2;
                    }
    ...
    private static void zza(int i, Context context, String str) {
        ...
        if (strZzi == null) {
            strZzi = resources.getString(C0231R.string.common_google_play_services_notification_ticker);
        }
        ...
        if (zzkz.zzai(context)) {
            zzu.zzU(zzlk.zzoV());
            notification = new Notification.Builder(context).setSmallIcon(C0231R.drawable.common_ic_googleplayservices).setPriority(2).setAutoCancel(true).setStyle(new Notification.BigTextStyle().bigText(strZzi + " " + strZzc)).addAction(C0231R.drawable.common_full_open_on_phone, resources.getString(C0231R.string.common_open_on_phone), errorPendingIntent).build();
        } else {
            String string = resources.getString(C0231R.string.common_google_play_services_notification_ticker);
            if (zzlk.zzoR()) {
