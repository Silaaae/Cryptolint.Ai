...
public abstract class zzi<T extends IInterface> implements Api.Client, zzj.zza {
    ...
    protected final class C1177zzi extends zzi<T>.zza {
        public C1177zzi(int i, Bundle bundle) {
            super(i, bundle);
        }
    ...
    protected void zza(int i, Bundle bundle, int i2) {
        this.mHandler.sendMessage(this.mHandler.obtainMessage(5, i2, -1, new C1177zzi(i, bundle)));
    }
