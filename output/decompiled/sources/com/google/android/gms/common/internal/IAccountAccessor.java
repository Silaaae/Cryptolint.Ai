...
public interface IAccountAccessor extends IInterface {
    ...
    public static abstract class zza extends Binder implements IAccountAccessor {
        ...
        private static class C1174zza implements IAccountAccessor {
            private IBinder zznF;

            C1174zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static IAccountAccessor zzaD(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IAccountAccessor)) ? new C1174zza(iBinder) : (IAccountAccessor) iInterfaceQueryLocalInterface;
        }
