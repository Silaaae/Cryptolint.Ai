...
public interface zzo extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzo {
        ...
        private static class C1178zza implements zzo {
            private IBinder zznF;

            C1178zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzo zzaF(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzo)) ? new C1178zza(iBinder) : (zzo) iInterfaceQueryLocalInterface;
        }
