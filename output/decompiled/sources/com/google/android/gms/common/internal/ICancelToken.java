...
public interface ICancelToken extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICancelToken {
        ...
        private static class C1175zza implements ICancelToken {
            private IBinder zznF;

            C1175zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static ICancelToken zzaE(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ICancelToken)) ? new C1175zza(iBinder) : (ICancelToken) iInterfaceQueryLocalInterface;
        }
