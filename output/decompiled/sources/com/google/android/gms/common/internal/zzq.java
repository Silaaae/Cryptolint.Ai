...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C1180zza implements zzq {
            private IBinder zznF;

            C1180zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzq zzaH(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzq)) ? new C1180zza(iBinder) : (zzq) iInterfaceQueryLocalInterface;
        }
