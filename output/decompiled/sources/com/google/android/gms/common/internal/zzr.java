...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C1181zza implements zzr {
            private IBinder zznF;

            C1181zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzr zzaI(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzr)) ? new C1181zza(iBinder) : (zzr) iInterfaceQueryLocalInterface;
        }
