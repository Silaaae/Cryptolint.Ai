...
public class zza {
    ...
    public static abstract class AbstractC1172zza<R extends Result, A extends Api.Client> extends AbstractPendingResult<R> implements zzb<R>, zzg.zze<A> {
        private final Api.ClientKey<A> zzVu;
        private AtomicReference<zzg.zzc> zzWm;

        protected AbstractC1172zza(Api.ClientKey<A> clientKey, GoogleApiClient googleApiClient) {
