...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C1339zza implements zzv {
            private IBinder zznF;

            C1339zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzv zzcD(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzv)) ? new C1339zza(iBinder) : (zzv) iInterfaceQueryLocalInterface;
        }
