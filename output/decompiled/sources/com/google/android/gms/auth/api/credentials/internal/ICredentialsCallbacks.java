...
public interface ICredentialsCallbacks extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICredentialsCallbacks {
        ...
        private static class C1168zza implements ICredentialsCallbacks {
            private IBinder zznF;

            C1168zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static ICredentialsCallbacks zzap(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ICredentialsCallbacks)) ? new C1168zza(iBinder) : (ICredentialsCallbacks) iInterfaceQueryLocalInterface;
        }
