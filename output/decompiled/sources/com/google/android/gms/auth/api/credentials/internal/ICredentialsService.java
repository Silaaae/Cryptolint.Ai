...
public interface ICredentialsService extends IInterface {
    ...
    public static abstract class zza extends Binder implements ICredentialsService {
        ...
        private static class C1169zza implements ICredentialsService {
            private IBinder zznF;

            C1169zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static ICredentialsService zzaq(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ICredentialsService)) ? new C1169zza(iBinder) : (ICredentialsService) iInterfaceQueryLocalInterface;
        }
