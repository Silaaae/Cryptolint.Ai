...
public interface zzac extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzac {
        ...
        private static class C1167zza implements zzac {
            private IBinder zznF;

            C1167zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzac zzac(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzac)) ? new C1167zza(iBinder) : (zzac) iInterfaceQueryLocalInterface;
        }
