...
public class zzg implements CapabilityApi {
    ...
    public PendingResult<CapabilityApi.AddLocalCapabilityResult> addLocalCapability(GoogleApiClient client, final String capability) {
        return client.zza(new com.google.android.gms.wearable.internal.zzf<CapabilityApi.AddLocalCapabilityResult>(client) { // from class: com.google.android.gms.wearable.internal.zzg.3
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.google.android.gms.common.api.zza.AbstractC1172zza
            public void zza(zzbk zzbkVar) throws RemoteException {
    ...
    public PendingResult<CapabilityApi.GetAllCapabilitiesResult> getAllCapabilities(GoogleApiClient client, final int filter) {
        return client.zza(new com.google.android.gms.wearable.internal.zzf<CapabilityApi.GetAllCapabilitiesResult>(client) { // from class: com.google.android.gms.wearable.internal.zzg.2
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.google.android.gms.common.api.zza.AbstractC1172zza
            public void zza(zzbk zzbkVar) throws RemoteException {
    ...
    public PendingResult<CapabilityApi.GetCapabilityResult> getCapability(GoogleApiClient client, final String capability, final int filter) {
        return client.zza(new com.google.android.gms.wearable.internal.zzf<CapabilityApi.GetCapabilityResult>(client) { // from class: com.google.android.gms.wearable.internal.zzg.1
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.google.android.gms.common.api.zza.AbstractC1172zza
            public void zza(zzbk zzbkVar) throws RemoteException {
    ...
    public PendingResult<CapabilityApi.RemoveLocalCapabilityResult> removeLocalCapability(GoogleApiClient client, final String capability) {
        return client.zza(new com.google.android.gms.wearable.internal.zzf<CapabilityApi.RemoveLocalCapabilityResult>(client) { // from class: com.google.android.gms.wearable.internal.zzg.4
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.google.android.gms.common.api.zza.AbstractC1172zza
            public void zza(zzbk zzbkVar) throws RemoteException {
