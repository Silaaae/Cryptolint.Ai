...
public interface zzaq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaq {
        ...
        private static class C1369zza implements zzaq {
        ...
        public static zzaq zzdN(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzaq)) ? new C1369zza(iBinder) : (zzaq) iInterfaceQueryLocalInterface;
        }
