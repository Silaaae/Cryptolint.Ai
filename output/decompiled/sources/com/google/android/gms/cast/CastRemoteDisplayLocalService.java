...
public abstract class CastRemoteDisplayLocalService extends Service {
    ...
    private static final int zzQX = C0231R.id.cast_notification_id;
    ...
    private Notification zzN(boolean z) {
        ...
        if (z) {
            i = C0231R.string.cast_notification_connected_message;
            i2 = C0231R.drawable.cast_ic_notification_on;
        } else {
            i = C0231R.string.cast_notification_connecting_message;
            i2 = C0231R.drawable.cast_ic_notification_connecting;
        }
        if (TextUtils.isEmpty(string)) {
            string = getString(i3);
        }
        Notification notificationBuild = new NotificationCompat.Builder(this).setContentTitle(string).setContentText(TextUtils.isEmpty(str) ? getString(i, new Object[]{this.zzRh.getFriendlyName()}) : str).setContentIntent(this.zzRe.zzRv).setSmallIcon(i2).setOngoing(true).addAction(android.R.drawable.ic_menu_close_clear_cancel, getString(C0231R.string.cast_notification_disconnect), zzlm()).build();
