...
public interface zzi extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzi {
        ...
        private static class C1171zza implements zzi {
            private IBinder zznF;

            C1171zza(IBinder iBinder) {
                this.zznF = iBinder;
            }
        ...
        public static zzi zzax(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzi)) ? new C1171zza(iBinder) : (zzi) iInterfaceQueryLocalInterface;
        }
