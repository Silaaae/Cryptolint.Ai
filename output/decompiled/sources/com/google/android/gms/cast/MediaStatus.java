        ...
        */
        public boolean zzg(JSONObject jSONObject) throws JSONException {
            ...
            while (i4 < length) {
                ...
                MediaQueueItem mediaQueueItemZzaD = zzaD(num.intValue());
                if (mediaQueueItemZzaD != null) {
                    boolean zZzg = z3 | mediaQueueItemZzaD.zzg(jSONObject2);
                    mediaQueueItemArr[i4] = mediaQueueItemZzaD;
                    z2 = i4 != zzaF(num.intValue()).intValue() ? true : zZzg;
                } else if (num.intValue() == MediaStatus.this.zzSa) {
                    mediaQueueItemArr[i4] = new MediaQueueItem.Builder(MediaStatus.this.zzRK).build();
                    mediaQueueItemArr[i4].zzg(jSONObject2);
                    z2 = true;
                } else {
            ...
            boolean z4 = this.zzSn.size() == length ? z3 : true;
