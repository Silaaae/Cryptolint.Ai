...
public final class WalletFragmentStyle implements SafeParcelable {
    ...
    public void zzaL(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(this.zzaSn <= 0 ? C0231R.style.WalletFragmentDefaultStyle : this.zzaSn, C0231R.styleable.WalletFragmentStyle);
        zza(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_buyButtonWidth, "buyButtonWidth");
        zza(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_buyButtonHeight, "buyButtonHeight");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_buyButtonText, "buyButtonText");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_buyButtonAppearance, "buyButtonAppearance");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsTextAppearance, "maskedWalletDetailsTextAppearance");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsHeaderTextAppearance, "maskedWalletDetailsHeaderTextAppearance");
        zza(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsBackground, "maskedWalletDetailsBackgroundColor", "maskedWalletDetailsBackgroundResource");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsButtonTextAppearance, "maskedWalletDetailsButtonTextAppearance");
        zza(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsButtonBackground, "maskedWalletDetailsButtonBackgroundColor", "maskedWalletDetailsButtonBackgroundResource");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsLogoTextColor, "maskedWalletDetailsLogoTextColor");
        zzb(typedArrayObtainStyledAttributes, C0231R.styleable.WalletFragmentStyle_maskedWalletDetailsLogoImageType, "maskedWalletDetailsLogoImageType");
