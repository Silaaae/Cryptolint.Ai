...
public final class WalletFragmentOptions implements SafeParcelable {
    ...
    public static WalletFragmentOptions zza(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0231R.styleable.WalletFragmentOptions);
        int i = typedArrayObtainStyledAttributes.getInt(C0231R.styleable.WalletFragmentOptions_appTheme, 0);
        int i2 = typedArrayObtainStyledAttributes.getInt(C0231R.styleable.WalletFragmentOptions_environment, 1);
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C0231R.styleable.WalletFragmentOptions_fragmentStyle, 0);
        int i3 = typedArrayObtainStyledAttributes.getInt(C0231R.styleable.WalletFragmentOptions_fragmentMode, 1);
